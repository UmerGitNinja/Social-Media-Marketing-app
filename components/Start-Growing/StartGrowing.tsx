  ...
  return (
    <section className="p-4 space-y-14 md:mx-16 sm:mx-6 mx-4 lg:mx-24 my-10">
      ...
      <div className="bg-[#182747] rounded-xl">
        <div className="flex items-center text-center flex-col bg-[url('/Images/content-footer-mobile.webp')] lg:bg-[url('/mages/content-footer.webp')] bg-no-repeat bg-auto bg-center space-y-4 px-4 py-28">
