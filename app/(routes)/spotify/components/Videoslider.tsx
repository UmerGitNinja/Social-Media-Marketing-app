    ...
    <>
      <Swiper
        ...
        pagination={{
          ...
          renderBullet: (index, className) => {
            return `<span class="${className}" style="width: 8px; height: 8px; background: #258352; justify-content:center;"></span>`;
          },
        }}
        modules={[Pagination]}
      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide
            key={slide}
            className="rounded-xl drop-shadow-[2px_2px_2px_rgba(37,131,82,.5)] max-md:!w-[150px]  max-md:!h-[150px] "
          >
            <video
              data-
