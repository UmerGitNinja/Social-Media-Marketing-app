  ...
  return (
    <div className="flex relative z-50 rounded-full p-2 w-full bg-white items-center">
      <div className="relative z-50 flex-[0.5] w-8 h-8">
        <Image alt="Spotify-icon" src={"/spotify.svg"} fill />
      </div>
      <div className="flex-[2.5] h-8 border-l-[1px] border-neutral-300">
        <input
          ...
          name="Query"
          placeholder="Enter your Spotify Artist name..."
      ...
      <button
        type="submit"
        className="px-4 sm:text-xl text-sm sm:font-semibold font-medium whitespace-nowrap rounded-full py-2 sm:py-6 flex-1 sm:flex-[1.5] bg-gradient-to-r from-yellow-400 to-[#F0991A]"
      >
        Start Promotion
      </button>
