...
const ClientResultComponent = () => {
  return (
    <section className="flex relative justify-center lg:justify-end lg:px-32 md:items-center md:bg-[url('/Images/our-client-result-bg-instagram.webp')] bg-[url('/Images/our-client-result-mobile-bg-instagram.webp')] h-[550px] bg-no-repeat bg-center bg-cover">
